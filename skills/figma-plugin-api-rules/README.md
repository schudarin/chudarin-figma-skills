...
A field-tested knowledge base of Figma Plugin API pitfalls and patterns, written for
...
rule is a `### slug` section at the end of the relevant topic file; facts about one
